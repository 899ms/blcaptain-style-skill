...
const REQUIRED = [
  ...
  "references/style-system.md","references/image-sourcing.md","references/qa-checklist.md",
  "references/image-overlay.md","references/screenshot-treatment.md","references/title-shortener.md",
