...
- **版式**：封面母体（Still Paper R01–R08）+ 正文骨架（essay / list / ledger / matrix / flow / compare / quote / map 路线图 …）+ 三轴变体（构图重心 / 纸色 / 视觉装置轮换）。相邻页不落同一骨架。配方见 `references/layout-recipes.md`、`references/category-cookbook.md` 与 `references/style-pack-catalog.md`。
...
- 内容规划 / 压缩阶梯：`references/category-cookbook.md` · `references/layout-recipes.md` · `references/title-shortener.md`
